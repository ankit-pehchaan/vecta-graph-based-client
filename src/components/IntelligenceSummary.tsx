    ...
    return (
      <div className="rounded-lg border border-gray-200 dark:border-gray-700 p-4 bg-white dark:bg-gray-950">
        <div className="flex items-center gap-2 mb-2">
          ...
          <h3 className="text-sm font-semibold text-gray-900 dark:text-white">Intelligence Summary</h3>
        </div>
        <p className="text-sm text-gray-500 dark:text-gray-400">AI insights will appear here as you chat...</p>
      </div>
    );
  }
  ...
  return (
    <div className="rounded-lg border border-gray-200 dark:border-gray-700 p-4 bg-white dark:bg-gray-950">
      <div className="flex items-center gap-2 mb-3">
        ...
        <h3 className="text-sm font-semibold text-gray-900 dark:text-white">Intelligence Summary</h3>
        {isStreaming && (
          <span className="px-2 py-0.5 bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-400 text-xs font-medium rounded-full animate-pulse">
            Analyzing...
          </span>
        )}
      </div>
